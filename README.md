...
<div><img src="https://github.com/akosbalasko/coffee-to-file/blob/main/assets/bmc-logo.png?raw=true" width="30"> from <b>Someone</b> </div>  <div><i>Thank you so much for Studio brightness ++!</i></div><br>
<div><img src="https://github.com/akosbalasko/coffee-to-file/blob/main/assets/bmc-logo.png?raw=true" width="30"> from <b>CLÉMENT F L DUMAS</b> </div>  <div><i>Studio-Brightness-PlusPlus works great, thanks!</i></div><br><!--END_SECTION:buy-me-a-coffe-->
